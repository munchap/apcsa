...
public class SecretCrossword
{
    ...
    public int getEntryLength()
    {
        ...
        String[] words = crosswordClue.split(" ");
        return words[0].length();      // replace this line
    }
    ...
    public String getEntry()
    {
        ...
        return crosswordClue.substring(0, getEntryLength());      // replace this line
    }
    ...
    public String getClue()
    {
        ...
        // first blank space
        return crosswordClue.substring(getEntryLength() + 1);      // replace this line
    }
    ...
    public String getFirstLetter()
    {
        ...
        return crosswordClue.substring(0, 1);      // replace this line
    }
    ...
    public boolean isCorrectGuess(String guess)
    {
        ...
        return guess.equals(getEntry());   // replace this line
    }
}
